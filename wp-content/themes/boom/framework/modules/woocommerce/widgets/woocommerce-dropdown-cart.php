							...
							<?php if ( !$cart_is_empty ) : ?>
										...
										<div class="qodef-item-wrapper">
											...
											<div class="qodef-item-info-holder">
												<div class="qodef-item-left">
													...
													<span class="qodef-quantity"><?php esc_html_e('Количество: ','startit'); echo esc_html($cart_item['quantity']); ?></span>
								...
								<div class="qodef-cart-bottom">
									<div class="qodef-subtotal-holder clearfix">
										<span class="qodef-total"><?php esc_html_e( 'Итого', 'startit' ); ?>:</span>
									...
									<div class="qodef-btns-holder clearfix">
										<a href="<?php echo esc_url($woocommerce->cart->get_cart_url()); ?>" class="qodef-btn-small view-cart"><?php esc_html_e( 'Корзина', 'startit' ); ?></a>
										<a href="<?php echo esc_url( $woocommerce->cart->get_checkout_url() ); ?>" class="qodef-btn-small checkout"><?php esc_html_e( 'Заказать', 'startit' ); ?></a>
									</div>
								</div>
							<?php else : ?>

								<li class="qodef-empty-cart"><?php esc_html_e( 'Нет товаров в корзине', 'startit' ); ?></li>
